...
public class ReviewController {
    ...
    @RequestMapping(path = "/hotels/{hotel_id}/reviews", method = RequestMethod.GET)
    public List<Review> getReviewsForHotel(@PathVariable int hotel_id) {
        return dao.getReviewsForHotel(hotel_id);
    }
