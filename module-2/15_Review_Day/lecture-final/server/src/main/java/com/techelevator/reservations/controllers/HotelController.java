...
import com.techelevator.reservations.model.NewReservationDto;
...
public class HotelController {
    ...
    public Reservation addReservation(@Valid @RequestBody NewReservationDto reservation)
            throws HotelNotFoundException {
        return null;
//        if (paymentProcessing.process(reservation.getPaymentDetails())) {
//
