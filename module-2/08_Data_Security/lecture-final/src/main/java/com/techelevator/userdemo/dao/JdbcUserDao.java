package com.techelevator.userdemo.dao;
...
public class JdbcUserDao implements UserDao {
    ...
    public User saveUser(String userName, String password) {
        ...
        Long newId = jdbcTemplate.queryForObject(sql, Long.class, userName, hashedPassword, saltString);

        if(newId == null) throw new RuntimeException("Id was not generated for user during save.");
    ...
    public boolean isUsernameAndPasswordValid(String userName, String password) {
        ...
        if (results.next()) {
            ...
            if(storedSalt == null || storedPassword == null) return false;
