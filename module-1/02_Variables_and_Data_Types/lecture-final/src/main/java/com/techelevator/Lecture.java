...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		double divisionAgain = 5.4 / 2;
		System.out.println(divisionAgain);

		/*
		20. What is 5 divided by 2?
		*/
		double twoPointFive = 5 / 2;
		System.out.println(twoPointFive);

		/*
		21. What is 5.0 divided by 2?
		*/
		double twoPointFiveCorrectly = 5.0 / 2;
		System.out.println(twoPointFiveCorrectly);

		/*
		22. What is 66.6 divided by 100? Is the answer you get right or wrong?
		*/
		double floatingPointResult = 66.6 / 100;
		...
		*/
		long threeBillion = 1_000_000_000 * 3L;
