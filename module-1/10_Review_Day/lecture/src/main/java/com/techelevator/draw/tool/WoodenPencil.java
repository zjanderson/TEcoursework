...
public class WoodenPencil {
	 ...
	 *
	 * @param length length of pencil
	 * @param shape shape of pencil
	 * @param hardness hardness of pencil
	 * @param color color of pencil
	 * @param sharpness sharpness of pencil
	 */
