<template>
  <main class="main">
    ...
    <div class="review" v-for="review in reviews" v-bind:key="review.id" v-bind:class="{ favorited: review.isFavorited}">
      ...
      <div class="rating" >
        <img src="../assets/star.png" alt="yellow 5-pointed star image" v-for="n in review.rating" v-bind:key="n">
      </div>
      <h3>{{ review.title }}</h3>
      <p>{{ review.review }}</p>
    ...
    return {
      ...
      reviews: [
        ...
        },
        {
          id: 1,
          title: 'What, a book?',
          reviewer: 'Maxwell Gladholm',
          rating: 5,
          review: 'It CERTAINLY is a book. I mean, I can see that. Pages kept together with glue, and then writing on it, in some language. BRILLIANT.',
          isFavorited: false
        }
      ]
    }
