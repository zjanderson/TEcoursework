  ...
  <div>
    ...
    <div v-else>
      ...
      <router-link
        class="btn editCard"
        tag="button"
        :to="{ name: 'EditCard', params: {cardID: this.cardID} }">
        Edit Card
      </router-link>
    ...
    <div class="board-actions" v-if="!isLoading">
      <router-link :to="{ name: 'Board', params: { id: this.boardID } }">Back to Board</router-link>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    deleteCard() {
      const shouldDeleteCard = confirm("Are you sure you want to delete this card? This action cannot be undone.")
